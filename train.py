...
class Trainer(object):
    def __init__(self, args):
        ...
        self.writer = SummaryWriter(log_dir='result/'+ self.save_dir)
        ...
        if args.scheduler   == 'CosineAnnealingLR':
            ...
            self.scheduler = lr_scheduler.StepLR(self.optimizer, 1000, 0.2)  
    ...
    def training(self,epoch):
        ...
        self.writer.add_scalar('Losses/train loss', self.train_loss, epoch)
        self.writer.add_scalar('args/lr', self.scheduler.get_last_lr(), epoch)
    ...
    def testing (self, epoch):
        ...
        with torch.no_grad():
            ...
            self.writer.add_scalar('Losses/eval_loss', test_loss, epoch)
            self.writer.add_scalar('Metric/mIoU', mean_IOU, epoch)
            # self.writer.add_scalar('Metric/Pd', pd, epoch)
            # self.writer.add_scalar('Metric/Fa', fa, epoch)
